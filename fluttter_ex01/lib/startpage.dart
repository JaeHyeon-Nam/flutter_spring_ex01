...
import 'package:ex01/dto/serviceinfo.dart';
import 'package:ex01/utils.dart';
import 'package:flutter/material.dart';


class StartPage extends StatelessWidget {
  StartPage({required Key key, required this.title, required this.serverInfo}) : super(key: key);
